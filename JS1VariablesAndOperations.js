...
console.log("The number of available seats left on this plane are " + availableFlightSeats);

console.log("Step 2:  Cost of Groceries");
var costOfGroceriesAtCheckout = 90.50;
console.log("The cost of groceries at checkout is $" + costOfGroceriesAtCheckout);
...
var streetAddress = '1234 magic st';
...
//  ↓ YOUR CODE HERE ↓
    console.log("I added a candy bar to my groceries.. The new total is $" + (costOfGroceriesAtCheckout+2.15 ))

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
    console.log("I changed my middle name and my middle initial is now " + (middleInitial="J"))

    console.log('Changing Seasons:')
//	The season has changed, update the hot outside variable	to be opposite of what it was
//  ↓ YOUR CODE HERE ↓
    console.log("It's a new season, therefore is it hot outside? " + !isItHotOutside)

    console.log('Full Name:')
//	Create a new variable called full name using the customer's
//  first name, the middle initial, and a last name of your choice
//  ↓ YOUR CODE HERE ↓
    var fullName = firstName + " " + middleInitial + " " + "Rodriguez"
...
//  ↓ YOUR CODE HERE ↓
    console.log("Hello, my name is " + fullName + " and my address is " + streetAddress)
